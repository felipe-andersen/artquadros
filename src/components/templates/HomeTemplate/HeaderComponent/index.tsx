...
async function HeaderComponent(props: SchemaComponent) {
            ...
            <Div>
                ...
                <div>
                    ...
                    <form>
                        ...
                        <input placeholder={translatedContent.header.form.seachInput.placeholder} aria-label={translatedContent.header.form.seachInput.placeholder}  aria-placeholder="" type="text"/>
